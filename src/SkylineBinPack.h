...
class SkylineBinPack  : public BinPack
{
	public:
		...
		SkylineBinPack(int binWidth, int binHeight, bool useWasteMap=true);

		/// (Re)initializes the packer to an empty bin of width x height units. Call whenever
		/// you need to restart with a new bin.
		void Init(int binWidth, int binHeight, bool useWasteMap=true);
		...
		const std::vector<std::string> enum_name = {"LevelBottomLeft", "LevelMinWasteFit"};
		...
		Rect Insert(int width, int height, LevelChoiceHeuristic method, const int &index);
