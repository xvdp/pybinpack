...
namespace rbp {
	...
	//ShelfNextFitBinPack::Node ShelfNextFitBinPack::Insert(int width, int height, const int &index)
	Rect ShelfNextFitBinPack::Insert(int width, int height, const int &index)
	{
		Rect newNode;
