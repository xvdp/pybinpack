...
class GuillotineBinPack : public BinPack
{
	public:
		...
		const std::vector<std::string> enum_name = {"RectBestAreaFit", "RectBestShortSideFit", "RectBestLongSideFit", "RectWorstAreaFit", "RectWorstShortSideFit", "RectWorstLongSideFit"};
		...
		const std::vector<std::string> enum_split_name = {"SplitShorterLeftoverAxis", "SplitLongerLeftoverAxis", "SplitMinimizeArea", "SplitMaximizeArea", "SplitShorterAxis", "SplitLongerAxis"};
		...
		Rect Insert(int width, int height, bool merge, FreeRectChoiceHeuristic rectChoice, GuillotineSplitHeuristic splitMethod, const int&  index);
	...
	//		FreeRectChoiceHeuristic rectChoice, GuillotineSplitHeuristic splitMethod);
		...
		// std::vector<Rect> usedRectangles; -> moved to pare
	...
	private:
		...
		Rect FindPositionForNewNode(int width, int height, FreeRectChoiceHeuristic rectChoice, int *nodeIndex, const int &index);
