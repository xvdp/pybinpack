...
Rect MaxRectsBinPack::Insert(int width, int height, FreeRectChoiceHeuristic method, const int&  index)
{
	Rect newNode;
...
void MaxRectsBinPack::Insert(std::vector<RectSize> &rects, std::vector<Rect> &dst, FreeRectChoiceHeuristic method, const int&  index)
{
	dst.clear();
