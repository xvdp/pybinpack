...
class MaxRectsBinPack : public BinPack
{
	public:
		...
		// index of array for external refernce
		void Insert(std::vector<RectSize> &rects, std::vector<Rect> &dst, FreeRectChoiceHeuristic method, const int&  index=0);

		/// Inserts a single rectangle into the bin, possibly rotated.
		// index of array for external refernce
		Rect Insert(int width, int height, FreeRectChoiceHeuristic method, const int&  index=0);
